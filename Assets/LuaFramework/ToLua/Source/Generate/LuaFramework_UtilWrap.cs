...
public class LuaFramework_UtilWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("CallGlobalLuaFunction", CallGlobalLuaFunction);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int CallGlobalLuaFunction(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			object[] o = LuaFramework.Util.CallGlobalLuaFunction(arg0, arg1);
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
